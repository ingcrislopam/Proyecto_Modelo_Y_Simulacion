...
namespace Formulario_Regresion_Cuadratica
{
    public partial class Formulario_Buscar : Form
    {
        ...
        private void Formulario_Buscar_Load(object sender, EventArgs e)
        {
            ...
            dtgDatos.DataSource = gestionCuadratica.Buscar();
        }
        ...
        private void dtgDatos_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            formulario.txtX.Text = Convert.ToString(this.dtgDatos.Rows[e.RowIndex].Cells[1].Value);
            formulario.txtY.Text = Convert.ToString(this.dtgDatos.Rows[e.RowIndex].Cells[2].Value);
            this.Hide();
            formulario.Show();
        }
    }
