...
namespace Formulario_Linea_De_Espera_Un_Canal
{
    public partial class Formulario_Buscar : Form
    {
        ...
        private void Formulario_Buscar_Load(object sender, EventArgs e)
        {
            ...
            dtgDatos.DataSource = gestionLineaEsperaUnCanal.Buscar();
        }
        ...
        private void dtgDatos_CellContentDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            formulario.cbbId1.SelectedValue = Convert.ToString(this.dtgDatos.Rows[e.RowIndex].Cells[1].Value);
            formulario.cbbId2.SelectedValue = Convert.ToString(this.dtgDatos.Rows[e.RowIndex].Cells[2].Value);
            formulario.txtMediaEntreLlegada.Text = Convert.ToString(this.dtgDatos.Rows[e.RowIndex].Cells[3].Value);
            formulario.txtMediaDeServicio.Text = Convert.ToString(this.dtgDatos.Rows[e.RowIndex].Cells[4].Value);
            this.Hide();
            formulario.Show();
        }
    }
